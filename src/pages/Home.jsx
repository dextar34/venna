                      ...
                      <ul className="flex flex-wrap gap-5 py-2">
                        {sizes.map((size) => (
                          <li
                            key={size}
                            className={cn(
                              "w-10 h-10 border-2 border-black flex justify-center items-center cursor-pointer",
                ...
                <div className="size addToCart py-3 flex flex-col justify-between gap-x-2 md:block">
                  ...
                  <div className="addtocart pt-5 md:mr-6">
                    <div className="up  flex flex-col md:flex-row justify-between gap-x-2 pb-2">
                      ...
                      <button className="border border-black text-center mt-2 md:mt-0 py-2 font-semibold bg-transparent w-auto md:w-72">
                        Add to Cart
                      </button>
                    </div>
        ...
        <Container className={'mx-7 md:mx-auto'}>
          ...
          <Slider {...settings}>
            {data.map((item, i) => (
              ...
              >
                <img src={item.pic1} alt="" className="w-full object-cover" />
                <h2>{item.name}</h2>
              </div>
            ))}
          </Slider>
